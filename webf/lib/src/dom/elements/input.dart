  ...
  void setBindingProperty(String key, val) {
    switch (key) {
      ...
      case 'readonly':
        ...
        break;
      case 'pattern':
        pattern = castToType<String>(val);
        break;
      case 'step':
        step = castToType<String>(val);
        break;
      case 'name':
        name = castToType<String>(val);
        break;
      case 'multiple':
        multiple = castToType<bool>(val);
        break;
      case 'checked':
        checked = castToType<bool>(val);
        break;
      case 'disabled':
        disabled = castToType<bool>(val);
        break;
      case 'min':
        min = castToType<String>(val);
        break;
      case 'max':
        max = castToType<String>(val);
        break;
      case 'minLength':
  ...
  void setAttribute(String qualifiedName, String val) {
    ...
    switch (qualifiedName) {
      ...
      case 'value':
        ...
        break;
      case 'accept':
        accept = attributeToProperty<String>(val);
        break;
      case 'autocomplete':
      ...
      case 'readonly':
        ...
        break;
      case 'pattern':
        pattern = attributeToProperty<String>(val);
        break;
      case 'step':
        step = attributeToProperty<String>(val);
        break;
      case 'name':
        name = attributeToProperty<String>(val);
        break;
      case 'multiple':
        multiple = attributeToProperty<bool>(val);
        break;
      case 'checked':
        checked = attributeToProperty<bool>(val);
        break;
      case 'disabled':
        disabled = attributeToProperty<bool>(val);
        break;
      case 'min':
        min = attributeToProperty<String>(val);
        break;
      case 'max':
        max = attributeToProperty<String>(val);
        break;
      case 'minlength':
      ...
      case 'placeholder':
        ...
        break;
      case 'type':
        type = attributeToProperty<String>(val);
        break;
      case 'inputmode':

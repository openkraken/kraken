...
class KrakenViewController implements WidgetsBindingObserver, ElementsBindingObserver {
  ...
  KrakenViewController(this._viewportWidth, this._viewportHeight,
      {this.background,
...
class KrakenController {
  ...
  KrakenController(
    ...
    assert(!_controllerMap.containsKey(contextId), 'found exist contextId of KrakenController, contextId: $contextId');

describe('display sliver', () => {
  ...
  it('should work with child style has been maintained when child is destroyed and recreated', async (done) => {
    ...
    for (let i = 0; i < 5; i++) {
      let div = createElement('div', {
        ...
        createText(i + ' aaaaaa bbbbbb cccccc dddddd eeeeee ffffff gggggg'),
        createElement('div', {
          style: {

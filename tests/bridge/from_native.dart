...
typedef NativeTestCallback = Void Function(Pointer<JSContext> context);
...
typedef Native_RefreshPaintCallback = Void Function(Pointer<JSCallbackContext>, Pointer<JSContext>, Pointer<Utf8>);
typedef Dart_RefreshPaintCallback = void Function(Pointer<JSCallbackContext>, Pointer<JSContext>, Pointer<Utf8>);
typedef Native_RefreshPaint = Void Function(Pointer<JSCallbackContext>, Pointer<JSContext>, Pointer<NativeFunction<Native_RefreshPaintCallback>>);
...
void _refreshPaint(Pointer<JSCallbackContext> callbackContext, Pointer<JSContext> context, Pointer<NativeFunction<Native_RefreshPaintCallback>> pointer) {
  Dart_RefreshPaintCallback callback = pointer.asFunction();
  KrakenViewController controller = KrakenViewController.getViewControllerOfJSContextIndex(0);
  controller.detachView();
  controller.attachView(RendererBinding.instance.renderView);
  callback(callbackContext, context, nullptr);
}
...
typedef Native_MatchImageSnapshotCallback = Void Function(Pointer<JSCallbackContext> callbackContext, Pointer<JSContext> context, Int8);
typedef Dart_MatchImageSnapshotCallback = void Function(Pointer<JSCallbackContext> callbackContext, Pointer<JSContext> context, int);
typedef Native_MatchImageSnapshot = Void Function(
    Pointer<JSCallbackContext> callbackContext, Pointer<JSContext> context,
...
void _matchImageSnapshot(Pointer<JSCallbackContext> callbackContext, Pointer<JSContext> context, Pointer<Uint8> bytes, int size, Pointer<Utf8> snapshotNamePtr, Pointer<NativeFunction<Native_MatchImageSnapshotCallback>> pointer) {
  ...
  matchImageSnapshot(bytes.asTypedList(size), Utf8.fromUtf8(snapshotNamePtr)).then((value) {
    callback(callbackContext, context, value ? 1 : 0);
  });
}

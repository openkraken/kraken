describe('delete-block-in-inlines', () => {
  it('beginning-001', async done => {
    ...
    append(container, createElement('span', {}, createText('Several')));
    append(container, createElement('span', {}, createText('inline elements')));
    append(container, createText(' are '));
    append(container, createElement('span', {}, createText('in this')));

it('flexShrink', () => {
  ...
  document.body.appendChild(document.createTextNode('flex-shrink test: row'));
  ...
  setStyle(child1, {
    backgroundColor: '#999', width: '300rpx'
  });
  ...
  setStyle(child2, {
    flexShrink: 2, backgroundColor: '#f40', width: '200rpx'
  });
  ...
  setStyle(child3, {
    flexShrink: 1, backgroundColor: 'green', width: '200rpx'
  });
  child3.appendChild(document.createTextNode('flex-shrink: 1'));
  container1.appendChild(child3);


  document.body.appendChild(document.createTextNode('flex-shrink test: column'));
  ...
  setStyle(child4, {
    backgroundColor: '#999', height: '300rpx'
  });
  ...
  setStyle(child5, {
    flexShrink: 2, backgroundColor: '#f40', height: '200rpx'
  });
  ...
  setStyle(child6, {
    flexShrink: 1, backgroundColor: 'green', height: '200rpx'
  });

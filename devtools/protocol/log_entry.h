...
//#include "debug/protocol/remote_object.h"
...
namespace kraken{
    namespace Debugger {
        ...
        public:
            ...
            void setSource(const std::string &value) { m_source = value; }
            ...
            void setStackTrace(
                    std::unique_ptr<StackTrace> value) {
            ...
            void setNetworkRequestId(const std::string &value) { m_networkRequestId = value; }
            ...
            void setWorkerId(const std::string &value) { m_workerId = value; }
...
//            }
            ...
            public:
                ...
                LogEntryBuilder<STATE | TimestampSet> &setTimestamp(double value) {
                    static_assert(!(STATE & TimestampSet),
                                  "property timestamp should not be set yet");
                ...
                LogEntryBuilder<STATE> &setStackTrace(
                        std::unique_ptr<StackTrace> value) {

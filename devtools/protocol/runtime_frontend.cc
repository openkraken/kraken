...
#include "devtools/protocol/execution_context_created_notification.h"
...
//            m_frontendChannel->sendProtocolNotification(InternalResponse::createNotification("Runtime.exceptionThrown", std::move(messageData)));
        ...
        void RuntimeFrontend::executionContextCreated(std::unique_ptr<ExecutionContextDescription> context) {
            ...
            m_frontendChannel->sendProtocolNotification({"Runtime.executionContextCreated", messageData->toValue(doc.GetAllocator())});
        }

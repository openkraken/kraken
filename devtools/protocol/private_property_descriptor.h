...
namespace kraken{
    namespace Debugger {
        ...
        public:
            ...
            RemoteObject *getValue() { return m_value.get(); }
            ...
            public:
                ...
                PrivatePropertyDescriptorBuilder<STATE | NameSet> &
                ...
                PrivatePropertyDescriptorBuilder<STATE | ValueSet> &
                setValue(std::unique_ptr<RemoteObject> value) {
            ...
            private:
                ...
                template<int STEP>
                PrivatePropertyDescriptorBuilder<STATE | STEP> &castState() {
                    return *reinterpret_cast<PrivatePropertyDescriptorBuilder<
                            STATE | STEP> *>(this);
                }

...
namespace kraken{
    namespace Debugger {
        ...
        public:
            ...
            std::string getBreakpointId() { return m_breakpointId; }

            void setBreakpointId(const std::string &value) { m_breakpointId = value; }
            ...
            public:
                ...
                BreakpointResolvedNotificationBuilder<STATE | BreakpointIdSet> &
                setBreakpointId(const std::string &value) {
                    static_assert(!(STATE & BreakpointIdSet),
                                  "property breakpointId should not be set yet");
                    m_result->setBreakpointId(value);
                    return castState<BreakpointIdSet>();
                }

                BreakpointResolvedNotificationBuilder<STATE | LocationSet> &
            ...
            private:
                ...
                BreakpointResolvedNotificationBuilder() : m_result(
                        new BreakpointResolvedNotification()) {}

                template<int STEP>
                BreakpointResolvedNotificationBuilder<STATE | STEP> &castState() {
                    return *reinterpret_cast<BreakpointResolvedNotificationBuilder<
                            STATE | STEP> *>(this);
                }

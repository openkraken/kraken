...
namespace kraken{
    namespace Debugger {
        ...
        public:
            ...
            RemoteObject* getObject() { return m_object.get(); }
            void setObject(std::unique_ptr<RemoteObject> value) { m_object = std::move(value); }

            bool hasName() { return m_name.isJust(); }
            std::string getName(const std::string& defaultValue) { return m_name.isJust() ? m_name.fromJust() : defaultValue; }
            void setName(const std::string& value) { m_name = value; }

            bool hasStartLocation() { return m_startLocation.isJust(); }
            Location* getStartLocation(Location* defaultValue) { return m_startLocation.isJust() ? m_startLocation.fromJust() : defaultValue; }
            void setStartLocation(std::unique_ptr<Location> value) { m_startLocation = std::move(value); }

            bool hasEndLocation() { return m_endLocation.isJust(); }
            Location* getEndLocation(Location* defaultValue) { return m_endLocation.isJust() ? m_endLocation.fromJust() : defaultValue; }
            void setEndLocation(std::unique_ptr<Location> value) { m_endLocation = std::move(value); }

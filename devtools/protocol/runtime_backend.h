...
#include "devtools/protocol/property_descriptor.h"
#include "devtools/protocol/internal_property_descriptor.h"
#include "devtools/protocol/private_property_descriptor.h"
...
namespace kraken{
    namespace Debugger {
        ...
        public:
            ...
            virtual void awaitPromise(const std::string& in_promiseObjectId,
                                      Maybe<bool> in_returnByValue,
                                      Maybe<bool> in_generatePreview,
                                      std::unique_ptr<AwaitPromiseCallback> callback) = 0;
            ...
            virtual void callFunctionOn(const std::string& in_functionDeclaration,
                                        ...
                                        std::unique_ptr<CallFunctionOnCallback> callback) = 0;

            virtual DispatchResponse compileScript(const std::string& in_expression,
            ...
            public:
                virtual void sendSuccess(std::unique_ptr<RemoteObject> result,
                                         Maybe<ExceptionDetails> exceptionDetails) = 0;
                virtual void sendFailure(const DispatchResponse&) = 0;
                virtual void fallThrough() = 0;
                virtual ~EvaluateCallback() { }
            };

            virtual void evaluate(const std::string& in_expression,
                                  Maybe<std::string> in_objectGroup,
            ...
            virtual DispatchResponse getProperties(const std::string& in_objectId,
            ...
            virtual DispatchResponse queryObjects(const std::string& in_prototypeObjectId,
                                                  Maybe<std::string> in_objectGroup,
            ...
            virtual void runScript(const std::string& in_scriptId,
                                   Maybe<int> in_executionContextId,
                                   Maybe<std::string> in_objectGroup,
                                   Maybe<bool> in_silent,
                                   Maybe<bool> in_includeCommandLineAPI,

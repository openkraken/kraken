...
namespace kraken{
    namespace Debugger {
        ...
        public:
            ...
            void setKey(std::unique_ptr<ObjectPreview> value) { m_key = std::move(value); }

            ObjectPreview *getValue() { return m_value.get(); }

            void setValue(std::unique_ptr<ObjectPreview> value) { m_value = std::move(value); }
            ...
            public:
                ...
                EntryPreviewBuilder<STATE | ValueSet> &
                setValue(std::unique_ptr<ObjectPreview> value) {

...
namespace kraken{
    namespace Debugger {
        std::unique_ptr<BreakpointResolvedNotification> BreakpointResolvedNotification::fromValue(
        ...
        rapidjson::Value BreakpointResolvedNotification::toValue(
            ...
            result.AddMember("location", m_location.get()->toValue(allocator), allocator);
            return result;
        }
    }
}
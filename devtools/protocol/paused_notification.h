...
namespace kraken{
    namespace Debugger {
        ...
        public:
            ...
            std::vector<std::unique_ptr<CallFrame>>* getCallFrames() { return m_callFrames.get(); }
            void setCallFrames(std::unique_ptr<std::vector<std::unique_ptr<CallFrame>>> value) { m_callFrames = std::move(value); }
            ...
            rapidjson::Value* getData(rapidjson::Value* defaultValue) { return m_data.isJust() ? m_data.fromJust() : defaultValue; }
            void setData(std::unique_ptr<rapidjson::Value> value) { m_data = std::move(value); }

            bool hasHitBreakpoints() { return m_hitBreakpoints.isJust(); }
            std::vector<std::string>* getHitBreakpoints(std::vector<std::string>* defaultValue) { return m_hitBreakpoints.isJust() ? m_hitBreakpoints.fromJust() : defaultValue; }
            void setHitBreakpoints(std::unique_ptr<std::vector<std::string>> value) { m_hitBreakpoints = std::move(value); }

            bool hasAsyncStackTrace() { return m_asyncStackTrace.isJust(); }
            StackTrace* getAsyncStackTrace(StackTrace* defaultValue) { return m_asyncStackTrace.isJust() ? m_asyncStackTrace.fromJust() : defaultValue; }
            void setAsyncStackTrace(std::unique_ptr<StackTrace> value) { m_asyncStackTrace = std::move(value); }

            bool hasAsyncStackTraceId() { return m_asyncStackTraceId.isJust(); }
            StackTraceId* getAsyncStackTraceId(StackTraceId* defaultValue) { return m_asyncStackTraceId.isJust() ? m_asyncStackTraceId.fromJust() : defaultValue; }
            void setAsyncStackTraceId(std::unique_ptr<StackTraceId> value) { m_asyncStackTraceId = std::move(value); }

            bool hasAsyncCallStackTraceId() { return m_asyncCallStackTraceId.isJust(); }
            StackTraceId* getAsyncCallStackTraceId(StackTraceId* defaultValue) { return m_asyncCallStackTraceId.isJust() ? m_asyncCallStackTraceId.fromJust() : defaultValue; }
            void setAsyncCallStackTraceId(std::unique_ptr<StackTraceId> value) { m_asyncCallStackTraceId = std::move(value); }
            ...
            public:
                ...
                PausedNotificationBuilder<STATE | CallFramesSet>& setCallFrames(std::unique_ptr<std::vector<std::unique_ptr<CallFrame>>> value)
                {

...
namespace kraken{
    namespace Debugger {
        class HeapProfilerDispatcherImpl : public DispatcherBase{
            ...
            , m_backend(backend) {
                ...
                m_dispatchMap["HeapProfiler.addInspectedHeapObject"] =
                        std::bind(&HeapProfilerDispatcherImpl::addInspectedHeapObject,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["HeapProfiler.collectGarbage"] =
                        std::bind(&HeapProfilerDispatcherImpl::collectGarbage,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["HeapProfiler.disable"] =
                        std::bind(&HeapProfilerDispatcherImpl::disable,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["HeapProfiler.enable"] =
                        std::bind(&HeapProfilerDispatcherImpl::enable,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["HeapProfiler.getHeapObjectId"] =
                        std::bind(&HeapProfilerDispatcherImpl::getHeapObjectId,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["HeapProfiler.getObjectByHeapObjectId"] =
                        std::bind(&HeapProfilerDispatcherImpl::getObjectByHeapObjectId,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["HeapProfiler.getSamplingProfile"] =
                        std::bind(&HeapProfilerDispatcherImpl::getSamplingProfile,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["HeapProfiler.startSampling"] =
                        std::bind(&HeapProfilerDispatcherImpl::startSampling,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["HeapProfiler.startTrackingHeapObjects"] =
                        std::bind(&HeapProfilerDispatcherImpl::startTrackingHeapObjects,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["HeapProfiler.stopSampling"] =
                        std::bind(&HeapProfilerDispatcherImpl::stopSampling,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["HeapProfiler.stopTrackingHeapObjects"] =
                        std::bind(&HeapProfilerDispatcherImpl::stopTrackingHeapObjects,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["HeapProfiler.takeHeapSnapshot"] =
                        std::bind(&HeapProfilerDispatcherImpl::takeHeapSnapshot,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
            }
        ...
        protected:
            ...
            void startTrackingHeapObjects(uint64_t callId, const std::string& method, jsonRpc::JSONObject message, ErrorSupport*);

...
namespace kraken{
    namespace Debugger {
        ...
        public:
            ...
            void setValue(std::unique_ptr<RemoteObject> value) { m_value = std::move(value); }
            ...
            void setGet(std::unique_ptr<RemoteObject> value) { m_get = std::move(value); }
            ...
            void setSet(std::unique_ptr<RemoteObject> value) { m_set = std::move(value); }
            ...
            void setSymbol(std::unique_ptr<RemoteObject> value) { m_symbol = std::move(value); }
            ...
            public:
                ...
                PropertyDescriptorBuilder<STATE | ConfigurableSet> &setConfigurable(bool value) {
                    static_assert(!(STATE & ConfigurableSet),
                                  "property configurable should not be set yet");
                ...
                PropertyDescriptorBuilder<STATE | EnumerableSet> &setEnumerable(bool value) {
                    static_assert(!(STATE & EnumerableSet),
                                  "property enumerable should not be set yet");

...
#include "devtools/protocol/object_preview.h"
...
namespace kraken{
    namespace Debugger {
        ...
        public:
            ...
            void setClassName(const std::string &value) { m_className = value; }
            ...
            void setValue(std::unique_ptr<rapidjson::Value> value) { m_value = std::move(value); }
            ...
            std::string getUnserializableValue(const std::string &defaultValue) {
                return m_unserializableValue.isJust() ? m_unserializableValue.fromJust()
                                                      : defaultValue;
            }

            void setUnserializableValue(const std::string &value) { m_unserializableValue = value; }
            ...
            void setObjectId(const std::string &value) { m_objectId = value; }
            ...
            void setPreview(std::unique_ptr<ObjectPreview> value) { m_preview = std::move(value); }

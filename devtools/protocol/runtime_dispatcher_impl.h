...
namespace kraken{
    namespace Debugger {
        ...
        public:
            ...
            , m_backend(backend) {
                m_dispatchMap["Runtime.awaitPromise"] =
                        std::bind(&RuntimeDispatcherImpl::awaitPromise,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["Runtime.callFunctionOn"] =
                        std::bind(&RuntimeDispatcherImpl::callFunctionOn,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["Runtime.compileScript"] =
                        std::bind(&RuntimeDispatcherImpl::compileScript,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["Runtime.disable"] =
                        std::bind(&RuntimeDispatcherImpl::disable,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["Runtime.discardConsoleEntries"] =
                        std::bind(&RuntimeDispatcherImpl::discardConsoleEntries,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["Runtime.enable"] =
                        std::bind(&RuntimeDispatcherImpl::enable,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["Runtime.evaluate"] =
                        std::bind(&RuntimeDispatcherImpl::evaluate,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["Runtime.getIsolateId"] =
                        std::bind(&RuntimeDispatcherImpl::getIsolateId,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["Runtime.getHeapUsage"] =
                        std::bind(&RuntimeDispatcherImpl::getHeapUsage,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["Runtime.getProperties"] =
                        std::bind(&RuntimeDispatcherImpl::getProperties,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["Runtime.globalLexicalScopeNames"] =
                        std::bind(&RuntimeDispatcherImpl::globalLexicalScopeNames,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["Runtime.queryObjects"] =
                        std::bind(&RuntimeDispatcherImpl::queryObjects,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["Runtime.releaseObject"] =
                        std::bind(&RuntimeDispatcherImpl::releaseObject,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["Runtime.releaseObjectGroup"] =
                        std::bind(&RuntimeDispatcherImpl::releaseObjectGroup,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["Runtime.runIfWaitingForDebugger"] =
                        std::bind(&RuntimeDispatcherImpl::runIfWaitingForDebugger,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["Runtime.runScript"] =
                        std::bind(&RuntimeDispatcherImpl::runScript,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                ...
                m_dispatchMap["Runtime.setCustomObjectFormatterEnabled"] =
                        std::bind(&RuntimeDispatcherImpl::setCustomObjectFormatterEnabled,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["Runtime.setMaxCallStackSizeToCapture"] =
                        std::bind(&RuntimeDispatcherImpl::setMaxCallStackSizeToCapture,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["Runtime.terminateExecution"] =
                        std::bind(&RuntimeDispatcherImpl::terminateExecution,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["Runtime.addBinding"] =
                        std::bind(&RuntimeDispatcherImpl::addBinding,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
                m_dispatchMap["Runtime.removeBinding"] =
                        std::bind(&RuntimeDispatcherImpl::removeBinding,this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
            }
        ...
        protected:
            ...
            void setCustomObjectFormatterEnabled(uint64_t callId, const std::string& method, jsonRpc::JSONObject message, ErrorSupport*);
            void setMaxCallStackSizeToCapture(uint64_t callId, const std::string& method, jsonRpc::JSONObject message, ErrorSupport*);

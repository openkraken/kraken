...
namespace kraken{
    namespace Debugger {
        ...
        public:
            ...
            ExecutionContextDescription *getContext() { return m_context.get(); }
            ...
            private:
                ...
                ExecutionContextCreatedNotificationBuilder() : m_result(
                        new ExecutionContextCreatedNotification()) {}

                template<int STEP>
                ExecutionContextCreatedNotificationBuilder<STATE | STEP> &castState() {
                    return *reinterpret_cast<ExecutionContextCreatedNotificationBuilder<
                            STATE | STEP> *>(this);
                }

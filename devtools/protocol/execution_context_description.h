...
namespace kraken{
    namespace Debugger {
        ...
        public:
            ...
            void setOrigin(const std::string &value) { m_origin = value; }
            ...
            public:
                ...
                ExecutionContextDescriptionBuilder<STATE | OriginSet> &
                setOrigin(const std::string &value) {
                    static_assert(!(STATE & OriginSet), "property origin should not be set yet");
                    m_result->setOrigin(value);
                    return castState<OriginSet>();
                }

                ExecutionContextDescriptionBuilder<STATE | NameSet> &
                ...
                ExecutionContextDescriptionBuilder<STATE> &
                setAuxData(std::unique_ptr<rapidjson::Value> value) {
            ...
            private:
                ...
                ExecutionContextDescriptionBuilder() : m_result(
                        new ExecutionContextDescription()) {}

                template<int STEP>
                ExecutionContextDescriptionBuilder<STATE | STEP> &castState() {
                    return *reinterpret_cast<ExecutionContextDescriptionBuilder<
                            STATE | STEP> *>(this);
                }

...
namespace kraken{
    namespace Debugger {
        ...
        public:
            ...
            rapidjson::Value* getExecutionContextAuxData(rapidjson::Value* defaultValue) { return m_executionContextAuxData.isJust() ? m_executionContextAuxData.fromJust() : defaultValue; }
            void setExecutionContextAuxData(std::unique_ptr<rapidjson::Value> value) { m_executionContextAuxData = std::move(value); }
            ...
            std::string getSourceMapURL(const std::string& defaultValue) { return m_sourceMapURL.isJust() ? m_sourceMapURL.fromJust() : defaultValue; }
            ...
            StackTrace* getStackTrace(StackTrace* defaultValue) { return m_stackTrace.isJust() ? m_stackTrace.fromJust() : defaultValue; }
            void setStackTrace(std::unique_ptr<StackTrace> value) { m_stackTrace = std::move(value); }

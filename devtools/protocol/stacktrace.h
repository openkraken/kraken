...
namespace kraken{
    namespace Debugger {
        ...
        public:
            ...
            void setParent(std::unique_ptr<StackTrace> value) { m_parent = std::move(value); }
            ...
            void setParentId(std::unique_ptr<StackTraceId> value) { m_parentId = std::move(value); }
            ...
            public:
                ...
                setCallFrames(std::unique_ptr<std::vector<std::unique_ptr<CallFrame>>> value) {
                    static_assert(!(STATE & CallFramesSet),
                                  "property callFrames should not be set yet");

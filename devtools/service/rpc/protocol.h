    ...
    namespace Debugger {
        namespace jsonRpc {
            ...
            public:
                ...
                Request(Request &&req) :
                        id(req.id), method(std::move(req.method)), params(std::move(req.params)) {
                }
            ...
            public:
                ...
                Error(Error &&err) :
                        code(err.code), message(std::move(err.message)), data(std::move(err.data)) {
                }
            ...
            public:
                ...
                Event(std::string method, JSONObject params)
                        : method(std::move(method)), params(std::move(params)) {}

                Event(Event &&event) :
                        method(std::move(event.method)), params(std::move(event.params)) {
                }

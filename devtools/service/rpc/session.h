...
#include "devtools/base/websocket/websocket_impl.h"
#include "devtools/service/rpc/protocol.h"
#include "devtools/service/rpc/object_mappber.h"
    ...
    namespace Debugger {
        namespace jsonRpc {
            ...
            public:
                ...
                RPCSession(std::shared_ptr<kraken::foundation::WebSocketSession> handle, size_t token_num,RPCSessionCloseObservable observable)
                        :_m_handle(handle),_token_num(token_num),_observable(observable) {
                    this->_m_handle->setOnMessageCallback(
                            std::bind(&RPCSession::_on_message,this, std::placeholders::_1));
...
//                    KRAKEN_LOG(VERBOSE) << "[rpc] session " << _token_num << " send message: " << message;
            ...
            private:
                ...
                std::shared_ptr<kraken::foundation::WebSocketSession> _m_handle;

//
// Created by rowandjj on 2019/3/29.
//
    ...
    namespace Debugger {
        namespace jsonRpc {
            ...
            inline Request serializeRequest(rapidjson::Document document) {
                ...
                JSONObject params = document.HasMember("params") ? document["params"].GetObject() : JSONObject(rapidjson::kObjectType);
            ...
            inline Response serializeResponse(rapidjson::Document document) {
                ...
                JSONObject result = document.HasMember("result") ? document["result"].GetObject() : JSONObject(rapidjson::kObjectType);
            ...
            inline std::string deserializeRequest(Debugger::jsonRpc::Request req) {
            ...
            inline std::string deserializeResponse(Debugger::jsonRpc::Response resp) {
                rapidjson::Document doc;
                doc.SetObject();
            ...
            inline std::string deserializeError(Debugger::jsonRpc::Error error) {
                rapidjson::Document doc;
                doc.SetObject();
            ...
            inline std::string deserializeEvent(Debugger::jsonRpc::Event event) {
                rapidjson::Document doc;
                doc.SetObject();

...
#include "devtools/protocol/runtime_frontend.h"
...
namespace kraken{
    namespace Debugger {
        ...
        public:
            JSCRuntimeAgentImpl(InspectorSessionImpl* session,
                                Debugger::AgentContext& context);
            ~JSCRuntimeAgentImpl() override ;


            /***************** RuntimeBackend *********************/
            void awaitPromise(const std::string& in_promiseObjectId,
                                      Maybe<bool> in_returnByValue,
                                      Maybe<bool> in_generatePreview,
                                      std::unique_ptr<AwaitPromiseCallback> callback) override ;


            void callFunctionOn(const std::string& in_functionDeclaration,
            ...
            DispatchResponse compileScript(const std::string& in_expression,
            ...
            void evaluate(const std::string& in_expression,
                                  Maybe<std::string> in_objectGroup,
            ...
            DispatchResponse getProperties(const std::string& in_objectId,
            ...
            DispatchResponse queryObjects(const std::string& in_prototypeObjectId,
                                                  Maybe<std::string> in_objectGroup,
            ...
            void runScript(const std::string& in_scriptId,
                                   Maybe<int> in_executionContextId,
                                   Maybe<std::string> in_objectGroup,
                                   Maybe<bool> in_silent,
                                   Maybe<bool> in_includeCommandLineAPI,

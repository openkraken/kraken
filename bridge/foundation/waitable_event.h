...
#ifndef KRAKEN_FOUNDATION_WAITABLE_EVENT_H_
#define KRAKEN_FOUNDATION_WAITABLE_EVENT_H_
...
private:
  ...
  KRAKEN_DISALLOW_COPY_AND_ASSIGN(AutoResetWaitableEvent);
};
...
private:
  ...
  KRAKEN_DISALLOW_COPY_AND_ASSIGN(ManualResetWaitableEvent);
};

} // namespace foundation

#endif // KRAKEN_FOUNDATION_WAITABLE_EVENT_H_

...
#ifndef KRAKEN_FOUNDATION_MEMORY_REF_COUNTED_H_
#define KRAKEN_FOUNDATION_MEMORY_REF_COUNTED_H_

#include "foundation/macros.h"
#include "foundation/ref_counted_internal.h"
...
#define FML_FRIEND_REF_COUNTED_THREAD_SAFE(T) friend class ::foundation::RefCountedThreadSafe<T>

// If you want to keep your constructor(s) private and still want to use
// |MakeRefCounted<T>()|, use this. (See the example above
// |RefCountedThreadSafe|.)
#define FML_FRIEND_MAKE_REF_COUNTED(T) friend class ::foundation::internal::MakeRefCountedHelper<T>

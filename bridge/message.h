...
/// This is a simple character processing library designed to handle strings in a specific format,
/// only supporting ascii encoding. don't use it to parse string which contains Chinese character.

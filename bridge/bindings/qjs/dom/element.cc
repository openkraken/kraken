...
JSValue Element::constructor(QjsContext *ctx, JSValue func_obj, JSValue this_val, int argc, JSValue *argv) {
  ...
  if (elementCreatorMap.count(name) > 0) {
    elementInstance = elementCreatorMap[name](this, tagName, document);
  } else {
    // Fallback to default Element class
    elementInstance = new ElementInstance(this, tagName, document);
  }
...
PROP_GETTER(Element, style)(QjsContext *ctx, JSValue this_val, int argc, JSValue *argv) {  return JS_NULL;}
...
PROP_GETTER(Element, nodeName)(QjsContext *ctx, JSValue this_val, int argc, JSValue *argv) {  return JS_NULL;}
PROP_SETTER(Element, nodeName)(QjsContext *ctx, JSValue this_val, int argc, JSValue *argv) {  return JS_NULL;}

PROP_GETTER(Element, tagName)(QjsContext *ctx, JSValue this_val, int argc, JSValue *argv) {  return JS_NULL;}
...
ElementInstance::ElementInstance(Element *element, JSValue &tagName, DocumentInstance *document): NodeInstance(element, NodeType::ELEMENT_NODE, document) {

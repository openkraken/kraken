...
class HTMLParser {
 public:
  static bool parseHTML(const char* code, size_t codeLength, NodeInstance* rootNode, bool isEntry);
  static bool parseHTML(std::string html, NodeInstance* rootNode, bool isEntry);

...
class EventListenerOptions : public DictionaryBase {
 public:
  static std::shared_ptr<EventListenerOptions> Create(JSContext* ctx, JSValue value, ExceptionState& exception_state) { return std::make_shared<EventListenerOptions>(); };

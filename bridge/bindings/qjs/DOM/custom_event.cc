...
JSValue CustomEvent::initCustomEvent(QjsContext *ctx, JSValue this_val, int argc, JSValue *argv) {
  ...
  auto *eventInstance = static_cast<CustomEventInstance *>(JS_GetOpaque(this_val, kHostClassInstanceClassId));
...
PROP_GETTER(CustomEvent, detail)(QjsContext *ctx, JSValue this_val, int argc, JSValue *argv) {
  auto *customEventInstance = static_cast<CustomEventInstance *>(JS_GetOpaque(this_val, kHostClassInstanceClassId));

...
class HTMLParser {
public:
  bool parseHTML(JSContext* context, JSStringRef sourceRef, ElementInstance* element);
...
private:
  ...
  void traverseHTML(JSContext* context, GumboNode *node, ElementInstance *element);

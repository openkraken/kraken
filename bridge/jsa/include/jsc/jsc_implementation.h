...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  jsa::PropNameID createPropNameIDFromAscii(const char* str, size_t length)
  override;
  jsa::PropNameID createPropNameIDFromUtf8(const uint8_t* utf8, size_t length)
  override;
  ...
  virtual std::shared_ptr<jsa::HostObject> getHostObject(
      const jsa::Object&) override;
  ...
  jsa::Value getProperty(const jsa::Object&, const jsa::PropNameID& name)
  override;
  ...
  jsa::Function createFunctionFromHostFunction(
      const jsa::PropNameID& name,

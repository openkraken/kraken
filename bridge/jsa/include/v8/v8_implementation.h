...
protected:
  ...
  class V8SymbolValue final : public PointerValue {
    V8SymbolValue(v8::Isolate *isolate, const std::atomic<bool> &ctxInvalid, v8::Local<v8::Symbol> sym
#ifndef NDEBUG
                  ,
...
#ifndef NDEBUG
    V8StringValue(v8::Isolate *isolate, v8::Local<v8::String> str, std::atomic<intptr_t> &counter);
#else
  ...
  template <typename T> class V8ObjectValue final : public PointerValue {
    V8ObjectValue(v8::Isolate *isolate, const std::atomic<bool> &ctxInvalid, v8::Local<v8::Object> &obj, T *privateData
#ifndef NDEBUG
                  ,
                  std::atomic<intptr_t> &counter
#endif
  ...
  jsa::PropNameID createPropNameIDFromAscii(const char *str, size_t length) override;
  ...
  jsa::ArrayBuffer createArrayBuffer(uint8_t *data, size_t length,
                                     jsa::ArrayBufferDeallocator<uint8_t> deallocator) override;
  ...
  void setValueAtIndexImpl(jsa::Array &, size_t i, const jsa::Value &value) override;
  ...
  jsa::Function createClassFromHostClass(const jsa::PropNameID &name, unsigned int paramCount,
                                         jsa::HostClassType classType, const jsa::Object &prototype) override;
...
private:
  ...
  template <typename T> jsa::Object createObject(v8::Local<v8::Object> &object, T *privateData) const;

  // Used by factory methods and clone methods
  jsa::JSContext::PointerValue *makeSymbolValue(v8::Local<v8::Symbol> sym) const;
  jsa::JSContext::PointerValue *makeStringValue(v8::Local<v8::String> value) const;
  template <typename T> jsa::JSContext::PointerValue *makeObjectValue(v8::Local<v8::Object> &obj, T *privateData) const;

...
class BlobPart {
 public:
  ...
  explicit BlobPart(JSContext* ctx, uint8_t* buffer, uint32_t length, size_t byte_offset, size_t byte_length, size_t byte_per_element): content_type_(ContentType::kArrayBufferView), bytes_(buffer), byte_length_(length)  {};

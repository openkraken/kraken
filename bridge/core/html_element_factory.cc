...
static void CreateHTMLFunctionMap() {
  ...
  static const CreateHTMLFunctionMapData data[] = {
      ...
      {html_names::karea, HTMLAreaConstructor}
      {html_names::b, HTMLElementConstructor}
      {html_names::kbase, HTMLBaseConstructor}
      {html_names::audio, HTMLAudioConstructor}
      {html_names::kbody, HTMLBodyConstructor}
      {html_names::br, HTMLBRElementConstructor}
      {html_names::button, HTMLButtonConstructor}
      {html_names::canvas, HTMLCanvasConstructor}
      {html_names::code, HTMLElementConstructor}
      {html_names::dd, HTMLElementConstructor}
      {html_names::kdetails, HTMLDetailsConstructor}
      {html_names::kdialog, HTMLDialogConstructor}
      {html_names::kdiv, HTMLDivConstructor}
      {html_names::em, HTMLElementConstructor}
      {html_names::kfont, HTMLFontConstructor}
      {html_names::form, HTMLFormConstructor}
      {html_names::kframe, HTMLFrameConstructor}
      {html_names::h1, HTMLHeadingElementConstructor}
      {html_names::h2, HTMLHeadingElementConstructor}
      {html_names::h3, HTMLHeadingElementConstructor}
      {html_names::h4, HTMLHeadingElementConstructor}
      {html_names::h5, HTMLHeadingElementConstructor}
      {html_names::h6, HTMLHeadingElementConstructor}
      {html_names::khead, HTMLHeadConstructor}
      {html_names::header, HTMLElementConstructor}
      {html_names::hgroup, HTMLElementConstructor}
      {html_names::hr, HTMLHRElementConstructor}
      {html_names::khtml, HTMLHtmlConstructor}
      {html_names::i, HTMLElementConstructor}
      {html_names::iframe, HTMLIFrameElementConstructor}
      {html_names::image, HTMLUnknownElementConstructor}
      {html_names::img, HTMLImageElementConstructor}
      {html_names::input, HTMLInputConstructor}
      {html_names::li, HTMLLIElementConstructor}
      {html_names::klink, HTMLLinkConstructor}
      {html_names::kmap, HTMLMapConstructor}
      {html_names::kmenu, HTMLMenuConstructor}
      {html_names::p, HTMLParagraphElementConstructor}
      {html_names::kparam, HTMLParamConstructor}
      {html_names::popup, HTMLPopupElementConstructor}
      {html_names::kpre, HTMLPreConstructor}
      {html_names::kscript, HTMLScriptConstructor}
      {html_names::section, HTMLElementConstructor}
      {html_names::select, HTMLSelectConstructor}
      {html_names::kspan, HTMLSpanConstructor}
      {html_names::strong, HTMLElementConstructor}
      {html_names::style, HTMLStyleConstructor}
      {html_names::ktemplate, HTMLTemplateConstructor}
      {html_names::textarea, HTMLTextAreaElementConstructor}
      {html_names::ktitle, HTMLTitleConstructor}

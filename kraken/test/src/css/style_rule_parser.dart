...
void main() {
  group('CSSStyleRuleParser', () {
    test('1', () {
      ...
      expect(styleRule.style.getPropertyValue('color'), 'red');
    });

    test('2', () {
      CSSStyleRule styleRule = CSSStyleRuleParser.parse('html{\n    color:black;\n}');
      expect(styleRule.selectorText, 'html');
      expect(styleRule.style.getPropertyValue('color'), 'black');
    });
    ...
    test('5', () {
      ...
      expect(styleRule.selectorText, '.foo');
      expect(styleRule.style.getPropertyValue('--custom'), 'some value');
    });
    ...
    test('7', () {
      ...
      expect(styleRule.selectorText, '.foo');
      expect(styleRule.style.getPropertyValue('backgroundImage'), 'url(data:image/png;base64, CNbyblAAAAHElEQVQI12P4)');
      expect(styleRule.style.getPropertyValue('backgroundColor'), 'red');
    });
    ...
    test('11', () {
      ...
      expect(styleRule.style.getPropertyValue('display'), 'none');
    });
    ...
    test('13', () {
      ...
      expect(styleRule.selectorText, '.foo');
      expect(styleRule.style.getPropertyValue('backgroundImage'), 'url( "./image (1).jpg" )');
    });

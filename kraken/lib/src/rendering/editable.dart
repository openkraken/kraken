...
// The default ellipsis for text painter.
...
class RenderEditable extends RenderBox with RelayoutWhenSystemFontsChangeMixin {
  ...
  RenderEditable({
    ...
    required this.textSelectionDelegate,
        ...
        assert((minLines == null) || (maxLines >= minLines), "minLines can't be greater than maxLines", ),
        assert(
        ...
        _textPainter = TextPainter(
          ...
          ellipsis: textOverflow == TextOverflow.ellipsis ? _kEllipsis : null,
        ),
  ...
  void _handleMovement(
    ...
    textSelectionDelegate.userUpdateTextEditingValue(textSelectionDelegate
        .textEditingValue
        .copyWith(selection: newSelection), SelectionChangedCause.keyboard);
  ...
  set textOverflow(TextOverflow value) {
    if (value != _textOverflow) {
      ...
      _textPainter.ellipsis =
          value == TextOverflow.ellipsis ? _kEllipsis : null;
      markNeedsLayout();
    }
  }
  ...
  double _preferredHeight(double width) {
    ...
    final bool lockedMax = minLines == null;
  ...
  void _layoutText({double minWidth = 0.0, double maxWidth = double.infinity}) {
    ...
    bool showCursor = _showCursor.value;
    ...
    final bool shouldClipWidth = _textOverflow == TextOverflow.ellipsis ||

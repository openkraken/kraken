...
mixin RenderPointerListenerMixin on RenderBox {
  ...
  void handleEvent(PointerEvent event, HitTestEntry entry) {
    ...
    var _onPointerDown = onPointerDown;
    var _onPointerMove = onPointerMove;
    var _onPointerUp = onPointerUp;
    var _onPointerCancel = onPointerCancel;
    var _onPointerSignal = onPointerSignal;

    if (_onPointerDown != null && event is PointerDownEvent)
      return _onPointerDown(event);
    if (_onPointerMove != null && event is PointerMoveEvent)
      return _onPointerMove(event);
    if (_onPointerUp != null && event is PointerUpEvent)
      return _onPointerUp(event);
    if (_onPointerCancel != null && event is PointerCancelEvent)
      return _onPointerCancel(event);
    if (_onPointerSignal != null && event is PointerSignalEvent)
      return _onPointerSignal(event);
  }
}

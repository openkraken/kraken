...
// Get the object property of dart side object.
// @TODO: The following code should be auto generated by Web IDL.
getObjectProperty(Object object, String key) {
  if (object is AnchorElement) {
    switch (key) {
      case 'href': return object.href;
      case 'target': return object.target;
      case 'rel': return object.rel;
      case 'type': return object.type;
      case 'protocol': return object.protocol;
      case 'host': return object.host;
      case 'hostname': return object.hostname;
      case 'port': return object.port;
      case 'pathname': return object.pathname;
      case 'search': return object.search;
      case 'hash': return object.hash;
    }
  } else if (object is LinkElement) {
    switch (key) {
      case 'disabled': return object.disabled;
      case 'rel': return object.rel;
      case 'href': return object.href;
      case 'type': return object.type;
    }
  } else if (object is ScriptElement) {
    switch (key) {
      case 'src': return object.src;
      case 'async': return object.async;
      case 'defer': return object.defer;
      case 'type': return object.type;
      case 'charset': return object.charset;
      case 'text': return object.text;
    }
  } else if (object is StyleElement) {
    switch (key) {
      case 'type': return object.type;
    }
  } else if (object is ObjectElement) {
    switch (key) {
      case 'type': return object.type;
      case 'data': return object.data;
    }
  } else if (object is InputElement) {
    switch (key) {
      case 'width': return object.width;
      case 'height': return object.height;
      case 'value': return object.value;
      case 'accept': return object.accept;
      case 'autocomplete': return object.autocomplete;
      case 'autofocus': return object.autofocus;
      case 'required': return object.required;
      case 'readOnly': return object.readOnly;
      case 'pattern': return object.pattern;
      case 'step': return object.step;
      case 'name': return object.name;
      case 'multiple': return object.multiple;
      case 'checked': return object.checked;
      case 'disabled': return object.disabled;
      case 'min': return object.min;
      case 'max': return object.max;
      case 'maxLength': return object.maxLength;
      case 'placeholder': return object.placeholder;
      case 'type': return object.type;
      case 'mode': return object.mode;
    }
  } else if (object is ImageElement) {
    switch (key) {
      case 'src': return object.src;
  ...
  if (object is Element) {
    switch (key) {
      case 'className': return object.className;
      case 'classList': return object.classList;
    }
  }
}

...
mixin ElementNativeMethods on Node {
  ...
  // static double _getViewModuleProperty(Pointer<NativeEventTarget> nativeEventTarget, int property) {
    // if (kProfileMode) {
    //   PerformanceTiming.instance().mark(PERF_DOM_FORCE_LAYOUT_START);
    // }
    // Element element = Element.getElementOfNativePtr(nativeEventTarget);
    // element.flushLayout();
    //
    // if (kProfileMode) {
  ...
  // static void _setViewModuleProperty(Pointer<NativeEventTarget> nativeElement, int property, double value) {
  ...
  // static Pointer<NativeBoundingClientRect> _getBoundingClientRect(Pointer<NativeEventTarget> nativeElement) {
  //   Element element = Element.getElementOfNativePtr(nativeElement);
  //   element.flushLayout();
  //   return element.boundingClientRect.toNative();
  // }

  // static Pointer<NativeString> _getStringValueProperty(Pointer<NativeEventTarget> nativeElement, Pointer<NativeString> property) {
  //   Element element = Element.getElementOfNativePtr(nativeElement);
  //   element.flushLayout();
  ...
  static void _click(Pointer<NativeEventTarget> nativeElement) {
    // Element element = Element.getElementOfNativePtr(nativeElement);
    // element.flushLayout();
    // element.handleMethodClick();
  }

  static void _scroll(Pointer<NativeEventTarget> nativeElement, int x, int y) {
    // Element element = Element.getElementOfNativePtr(nativeElement);
    // element.flushLayout();
    // element.scrollTo(x: x, y: y, withAnimation: false);
  }

  static void _scrollBy(Pointer<NativeEventTarget> nativeElement, int x, int y) {
    // Element element = Element.getElementOfNativePtr(nativeElement);
    // element.flushLayout();
    // element.scrollBy(dx: x, dy: y, withAnimation: false);
  }

  void bindNativeMethods(Pointer<NativeEventTarget> nativeElement) {

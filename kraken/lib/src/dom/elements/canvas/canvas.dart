...
class CanvasElement extends Element {
  ...
  Size get size {
    ...
    double? styleWidth = renderStyle.width.isAuto ? null : renderStyle.width.compute(renderStyle);
    double? styleHeight = renderStyle.height.isAuto ? null : renderStyle.height.compute(renderStyle);

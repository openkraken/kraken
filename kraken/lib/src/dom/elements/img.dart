  ...
  void _loadImage() {
    ...
    if (_source == null || _source != source) {
      ...
      if (source != null && source.isNotEmpty) {
        _removeStreamListener();
        _image = CSSUrl.parseUrl(elementManager.controller.uriParser.parse(elementManager.contextId, Uri.parse(source)).toString(), cache: properties['caching'], contextId: elementManager.contextId);
